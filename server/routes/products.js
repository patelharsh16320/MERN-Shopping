...
const { getProducts, getAdminProducts, getProductById, createProduct, updateProduct, deleteProduct, addReview, updateReview, getFeatured, getCategories, exportProducts, importProducts, getAllReviews, updateReviewAdmin, deleteReviewAdmin } = require('../controllers/productController');
